...
Back to Bayes-ics today. And a return to something a bit closer to home: actuarial math. I had started this, presuming that I would uncover something fascinating about applying Bayesian inference to a low-frequency claims generation process. That isn't at all what I got. What I may have achieved, though, is still something profound. (Profound to me, anyway. As is typically the case, it's probably obvious to most other people.)
...
```{r GenerateClaims, warning = FALSE, fig.width = 15}
numClaims = 100
severity = 3500
...
So here is where it gets interesting. What I've read in Albert and pretty much everything that I've read in the actuarial literature are focused on measuring the predictive value of a single body of data against some larger whole. The aim is to assess just how much weight one should assign to an element of a set versus the weight assigned to the rest of the set. But there's something 
